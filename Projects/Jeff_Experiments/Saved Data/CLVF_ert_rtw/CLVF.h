...
typedef struct {
  ...
  real_T rC_D_tmp[3];
  real_T C_IB_b[3];
  real_T rtb_TmpSignalConversionAtSFu_pb[3];
  real_T c_I[3];
  real_T dv[3];
  real_T dv1[3];
  ...
  real_T RED_Tz_Elbow;
  real_T rtb_TmpSignalConversionAtSFu_pp;
  ...
  boolean_T rtb_Compare_nd_d;
  boolean_T rtb_Compare_n_g;
