###########################################################################
## Makefile generated for Simulink model 'CLVF'. 
## 
## Makefile     : CLVF.mk
## Generated on : Wed Apr 06 21:29:14 2022
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CLVF.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/Jeff-SPOT/Projects/Jeff_Experiments/Saved_Data
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CLVF.elf
...
DEFINES_STANDARD = -DMODEL=CLVF -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/CLVF_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/CLVF_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/CLVF_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
socket.cpp.o : $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/Jeff-SPOT/Custom_Library/PhaseSpase_Cameras/PHASESPACE/src/socket.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


owl_rpd.cpp.o : $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/Jeff-SPOT/Custom_Library/PhaseSpase_Cameras/PHASESPACE/src/owl_rpd.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


owl.cpp.o : $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/Jeff-SPOT/Custom_Library/PhaseSpase_Cameras/PHASESPACE/src/owl.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


libowl_socket.cpp.o : $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/Jeff-SPOT/Custom_Library/PhaseSpase_Cameras/PHASESPACE/src/libowl_socket.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


libowl.cpp.o : $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/Jeff-SPOT/Custom_Library/PhaseSpase_Cameras/PHASESPACE/src/libowl.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


filters.cpp.o : $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/Jeff-SPOT/Custom_Library/PhaseSpase_Cameras/PHASESPACE/src/filters.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


phasespace_functions.cpp.o : $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/Jeff-SPOT/Custom_Library/PhaseSpase_Cameras/PHASESPACE/src/phasespace_functions.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/CLVF_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CLVF.cpp.o : $(START_DIR)/CLVF_ert_rtw/CLVF.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CLVF_data.cpp.o : $(START_DIR)/CLVF_ert_rtw/CLVF_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.cpp.o : $(START_DIR)/CLVF_ert_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.cpp.o : $(START_DIR)/CLVF_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.cpp.o : $(START_DIR)/CLVF_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_zcfcn.cpp.o : $(START_DIR)/CLVF_ert_rtw/rt_zcfcn.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
