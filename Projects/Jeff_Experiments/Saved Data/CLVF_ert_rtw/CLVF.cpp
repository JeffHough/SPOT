...
void CLVF_step0(void)                  // Sample time: [0.0s, 0.0s]
{
...

  {
    ...
    switch (CLVF_B.rtAction) {
     ...
     case 2:
      ...
      if ((CLVF_P.WhoAmI == 3.0) || (CLVF_P.simMode == 1.0)) {
        ...
        // Sum: '<S294>/Subtract2'
        CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_m.Ox[0] -
          CLVF_B.sf_MATLABFunction3_c.Ox[0];
        CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_m.Ox[1] -
      ...
      if ((CLVF_P.WhoAmI == 1.0) || (CLVF_P.simMode == 1.0)) {
        ...
        // Sum: '<S307>/Subtract2'
        CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_ol.Ox[0] -
          CLVF_B.sf_MATLABFunction3_k.Ox[0];
        CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_ol.Ox[1] -
     ...
     case 3:
      ...
      if (CLVF_B.rtAction == 0) {
        ...
        switch (CLVF_B.rtAction) {
         case 0:
          ...
          // Sum: '<S329>/Subtract2'
          CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_h.Ox[0] -
            CLVF_B.sf_MATLABFunction3_a.Ox[0];
          CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_h.Ox[1] -
         ...
         case 3:
          ...
          // Sum: '<S340>/Subtract2'
          CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_c.Ox[0] -
            CLVF_B.sf_MATLABFunction3_f.Ox[0];
          CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_c.Ox[1] -
          ...
          if (CLVF_B.rtAction == 0) {
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3; CLVF_B.uElOffset1
                 ++) {
              CLVF_B.vc_m = CLVF_B.C_IB[CLVF_B.uElOffset1 + 3];
              CLVF_B.dgdr = CLVF_B.vc_m * CLVF_P.o_hat_B[1] +
                CLVF_B.C_IB[CLVF_B.uElOffset1] * CLVF_P.o_hat_B[0];
              CLVF_B.vc_dot = CLVF_B.vc_m * CLVF_P.Constant1_Value_e +
                CLVF_B.C_IB[CLVF_B.uElOffset1] * CLVF_P.Constant_Value_d;
              CLVF_B.rtb_TmpSignalConversionAtSFu_pp = CLVF_B.vc_m *
                CLVF_P.Constant_Value_hr[1] + CLVF_B.C_IB[CLVF_B.uElOffset1] *
                CLVF_P.Constant_Value_hr[0];
              CLVF_B.vc_m = CLVF_B.C_IB[CLVF_B.uElOffset1 + 6];
              CLVF_B.dgdr += CLVF_B.vc_m * CLVF_P.o_hat_B[2];
              CLVF_B.vc_dot += CLVF_B.vc_m * CLVF_B.RED_Tz_Shoulder;
              CLVF_B.rtb_TmpSignalConversionAtSFu_pp += CLVF_B.vc_m *
              ...
              CLVF_B.w_dot_I[CLVF_B.uElOffset1] =
                CLVF_B.rtb_TmpSignalConversionAtSFu_pp;
            }
            ...
            // MATLAB Function: '<S351>/Lyapunov Guidance + FF'
            CLVF_B.rtb_TmpSignalConversionAtSFun_j += CLVF_B.RED_Tz_Wrist *
              CLVF_B.o_hat[1];
            CLVF_B.TmpSignalConversionAtSFun_n[1] = CLVF_B.RED_Tz_Wrist /
              CLVF_B.RED_Tz_Shoulder;
            ...
            CLVF_B.rtb_TmpSignalConversionAtSFun_j += CLVF_B.RED_Tz_Elbow *
              CLVF_B.o_hat[2];
            CLVF_B.rtb_TmpSignalConversionAtSFu_pp = CLVF_B.RED_Tz_Elbow /
              CLVF_B.RED_Tz_Shoulder;
            ...
            CLVF_B.theta_n = acos(CLVF_B.rtb_TmpSignalConversionAtSFun_j / (sqrt
            ...
            CLVF_B.y6 = cos(CLVF_B.theta_n);
            CLVF_B.vc_dot = sin(CLVF_B.theta_n);
            ...
            CLVF_B.del[2] = (CLVF_B.o_hat[2] -
                             CLVF_B.rtb_TmpSignalConversionAtSFu_pp * CLVF_B.y6)
              / (CLVF_B.vc_dot + 1.0E-6);
            ...
            if (CLVF_B.y7 <= CLVF_P.b) {
              ...
              CLVF_B.vc_m = CLVF_P.a - CLVF_B.RED_Tz_Shoulder;
              if (CLVF_B.vc_m < 0.0) {
                CLVF_B.vc_m = -1.0;
              } else if (CLVF_B.vc_m > 0.0) {
                CLVF_B.vc_m = 1.0;
              } else if (CLVF_B.vc_m == 0.0) {
                CLVF_B.vc_m = 0.0;
              } else {
              ...
              CLVF_B.vc_m *= -CLVF_P.kc / (CLVF_P.b * CLVF_P.b) * (CLVF_B.y7 *
            ...
            CLVF_B.e_hat[0] = CLVF_B.TmpSignalConversionAtSFun_n[1] *
              CLVF_B.del[2] - CLVF_B.rtb_TmpSignalConversionAtSFu_pp *
              CLVF_B.del[1];
            CLVF_B.e_hat[1] = CLVF_B.rtb_TmpSignalConversionAtSFu_pp *
            ...
            CLVF_B.C_IB[4] = 1.0;
            CLVF_B.C_IB[8] = 1.0;
            CLVF_B.theta_n = (CLVF_B.del[0] * CLVF_B.o_hat[0] + CLVF_B.del[1] *
                              CLVF_B.o_hat[1]) + CLVF_B.del[2] * CLVF_B.o_hat[2];
            CLVF_B.rtb_TmpSignalConversionAtSFun_j =
              (CLVF_B.TmpSignalConversionAtSFun_n[0] * CLVF_B.o_hat[0] +
               CLVF_B.TmpSignalConversionAtSFun_n[1] * CLVF_B.o_hat[1]) +
              CLVF_B.rtb_TmpSignalConversionAtSFu_pp * CLVF_B.o_hat[2];
            CLVF_B.rtb_TmpSignalConversionAtSFun_l =
              (CLVF_B.TmpSignalConversionAtSFun_n[0] * CLVF_B.vC_T[0] +
               CLVF_B.TmpSignalConversionAtSFun_n[1] * CLVF_B.vC_T[1]) +
              CLVF_B.rtb_TmpSignalConversionAtSFu_pp * CLVF_B.vC_T[2];
            ...
            CLVF_B.g_dot = CLVF_B.dgdr * CLVF_B.rtb_TmpSignalConversionAtSFun_l;
            ...
            CLVF_B.RED_Tz_Shoulder = CLVF_B.d_T[1] *
              CLVF_B.rtb_TmpSignalConversionAtSFu_pp - CLVF_B.d_T[2] *
              CLVF_B.TmpSignalConversionAtSFun_n[1];
            CLVF_B.h[0] = (CLVF_B.RED_Tz_Shoulder * CLVF_B.g + (CLVF_B.vc_m *
              CLVF_B.TmpSignalConversionAtSFun_n[0] + CLVF_B.RED_Tz_Wrist *
              CLVF_B.del[0])) + CLVF_P.Constant_Value_e[0];
            CLVF_B.y6 = CLVF_B.d_T[2] * CLVF_B.TmpSignalConversionAtSFun_n[0] -
              CLVF_B.d_T[0] * CLVF_B.rtb_TmpSignalConversionAtSFu_pp;
            CLVF_B.h[1] = (CLVF_B.y6 * CLVF_B.g + (CLVF_B.vc_m *
              CLVF_B.TmpSignalConversionAtSFun_n[1] + CLVF_B.RED_Tz_Wrist *
              CLVF_B.del[1])) + CLVF_P.Constant_Value_e[1];
            CLVF_B.rtb_TmpSignalConversionAtSFun_l = CLVF_B.d_T[0] *
              CLVF_B.TmpSignalConversionAtSFun_n[1] - CLVF_B.d_T[1] *
              CLVF_B.TmpSignalConversionAtSFun_n[0];
            CLVF_B.h[2] = (CLVF_B.rtb_TmpSignalConversionAtSFun_l * CLVF_B.g +
                           (CLVF_B.vc_m * CLVF_B.rtb_TmpSignalConversionAtSFu_pp
                            + CLVF_B.RED_Tz_Wrist * CLVF_B.del[2])) +
              CLVF_P.Constant_Value_e[2];
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3; CLVF_B.uElOffset1
                 ++) {
              CLVF_B.rtb_TmpSignalConversionAtSFu_pb[CLVF_B.uElOffset1] =
                -CLVF_B.TmpSignalConversionAtSFun_n[CLVF_B.uElOffset1];
              CLVF_B.C_IB_c[3 * CLVF_B.uElOffset1] = (CLVF_B.C_IB[3 *
                CLVF_B.uElOffset1] - CLVF_B.del[0] *
                CLVF_B.del[CLVF_B.uElOffset1]) / (CLVF_B.theta_n + 1.0E-6);
              CLVF_B.ntIdx1 = 3 * CLVF_B.uElOffset1 + 1;
              CLVF_B.C_IB_c[CLVF_B.ntIdx1] = (CLVF_B.C_IB[CLVF_B.ntIdx1] -
                CLVF_B.del[1] * CLVF_B.del[CLVF_B.uElOffset1]) / (CLVF_B.theta_n
                + 1.0E-6);
              CLVF_B.ntIdx1 = 3 * CLVF_B.uElOffset1 + 2;
              CLVF_B.C_IB_c[CLVF_B.ntIdx1] = (CLVF_B.C_IB[CLVF_B.ntIdx1] -
                CLVF_B.del[2] * CLVF_B.del[CLVF_B.uElOffset1]) / (CLVF_B.theta_n
                + 1.0E-6);
            }
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3; CLVF_B.uElOffset1
              ...
              CLVF_B.rtb_TmpSignalConversionAtSFu_kk[3 * CLVF_B.uElOffset1] =
                CLVF_B.rtb_TmpSignalConversionAtSFu_pb[0] *
                CLVF_B.o_hat[CLVF_B.uElOffset1] - static_cast<real_T>(b_1[3 *
                CLVF_B.uElOffset1]) * CLVF_B.rtb_TmpSignalConversionAtSFun_j;
              CLVF_B.yElIdx = 3 * CLVF_B.uElOffset1 + 1;
              CLVF_B.rtb_TmpSignalConversionAtSFu_kk[CLVF_B.yElIdx] =
                CLVF_B.rtb_TmpSignalConversionAtSFu_pb[1] *
                CLVF_B.o_hat[CLVF_B.uElOffset1] - static_cast<real_T>
                (b_1[CLVF_B.yElIdx]) * CLVF_B.rtb_TmpSignalConversionAtSFun_j;
              CLVF_B.yElIdx = 3 * CLVF_B.uElOffset1 + 2;
              CLVF_B.rtb_TmpSignalConversionAtSFu_kk[CLVF_B.yElIdx] =
                CLVF_B.rtb_TmpSignalConversionAtSFu_pb[2] *
                CLVF_B.o_hat[CLVF_B.uElOffset1] - static_cast<real_T>
                (b_1[CLVF_B.yElIdx]) * CLVF_B.rtb_TmpSignalConversionAtSFun_j;
            }

            CLVF_B.rtb_TmpSignalConversionAtSFun_j = CLVF_B.d_T[1] *
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3; CLVF_B.uElOffset1
                 ++) {
              CLVF_B.C_IB_b[CLVF_B.uElOffset1] = 0.0;
              for (CLVF_B.yElIdx = 0; CLVF_B.yElIdx < 3; CLVF_B.yElIdx++) {
                ...
                CLVF_B.vc[CLVF_B.yElIdx + 3 * CLVF_B.uElOffset1] =
                  ...
                  (CLVF_B.theta_n + 1.0E-6);
                CLVF_B.C_IB_b[CLVF_B.uElOffset1] += CLVF_B.C_IB[CLVF_B.ntIdx1] *
                  CLVF_B.r_hat_dot[CLVF_B.yElIdx];
              }
            }

            CLVF_B.rtb_TmpSignalConversionAtSFu_pb[0] = CLVF_B.RED_Tz_Shoulder *
              CLVF_B.g_dot;
            CLVF_B.rtb_TmpSignalConversionAtSFu_pb[1] = CLVF_B.y6 * CLVF_B.g_dot;
            CLVF_B.rtb_TmpSignalConversionAtSFu_pb[2] =
              CLVF_B.rtb_TmpSignalConversionAtSFun_l * CLVF_B.g_dot;
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3; CLVF_B.uElOffset1
              ...
              CLVF_B.a_ff[CLVF_B.uElOffset1] = ((((((CLVF_B.vc_dot *
                CLVF_B.TmpSignalConversionAtSFun_n[CLVF_B.uElOffset1] +
                CLVF_B.vc_m * CLVF_B.r_hat_dot[CLVF_B.uElOffset1]) + CLVF_B.dgdr
                * CLVF_B.del[CLVF_B.uElOffset1]) +
                (CLVF_B.C_IB_b[CLVF_B.uElOffset1] + (CLVF_B.vc[CLVF_B.uElOffset1
                + 6] * CLVF_B.v_rel + (CLVF_B.vc[CLVF_B.uElOffset1 + 3] *
                CLVF_B.y7 + CLVF_B.vc[CLVF_B.uElOffset1] *
                CLVF_B.rtb_TmpSignalConversionAtSFun_j))) * CLVF_B.RED_Tz_Wrist)
                + CLVF_B.rtb_TmpSignalConversionAtSFu_pb[CLVF_B.uElOffset1]) +
            ...
            CLVF_B.rtb_TmpSignalConversionAtSFu_pb[0] = CLVF_B.uHzLPFilter -
              CLVF_P.Constant_Value_e[0];
            CLVF_B.rtb_TmpSignalConversionAtSFu_pb[1] = CLVF_B.uHzLPFilter1 -
              CLVF_P.Constant_Value_e[1];
            CLVF_B.rtb_TmpSignalConversionAtSFu_pb[2] = CLVF_P.Constant1_Value -
              CLVF_P.Constant_Value_e[2];
            ...
            for (CLVF_B.yElIdx = 0; CLVF_B.yElIdx < 3; CLVF_B.yElIdx++) {
              ...
              CLVF_B.C_IB_b[CLVF_B.yElIdx] = 0.0;
              ...
              for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3;
                ...
                CLVF_B.C_IB_b[CLVF_B.yElIdx] += CLVF_B.C_IB_c[CLVF_B.ntIdx1] *
              ...
              CLVF_B.e_hat[CLVF_B.yElIdx] =
                CLVF_B.rtb_TmpSignalConversionAtSFu_pb[CLVF_B.yElIdx] -
                CLVF_B.C_IB_b[CLVF_B.yElIdx];
              CLVF_B.rtb_TmpSignalConversionAtSFun_j =
                CLVF_B.TmpSignalConversionAtSFun_n[CLVF_B.yElIdx] -
                CLVF_B.rC_D_tmp[CLVF_B.yElIdx];
              CLVF_B.del[CLVF_B.yElIdx] = CLVF_B.rtb_TmpSignalConversionAtSFun_j
                * CLVF_B.rtb_TmpSignalConversionAtSFun_j;
              CLVF_B.TmpSignalConversionAtSFun_n[CLVF_B.yElIdx] =
                CLVF_B.rtb_TmpSignalConversionAtSFun_j;
            }
            ...
            CLVF_B.theta_n = acos(CLVF_B.vc_dot / (CLVF_B.RED_Tz_Shoulder *
              CLVF_B.RED_Tz_Wrist));
            ...
            // 'skew:6' A = [0 -v(3) v(2);v(3) 0 -v(1) ; -v(2) v(1) 0];
            // 'skew:6' A = [0 -v(3) v(2);v(3) 0 -v(1) ; -v(2) v(1) 0];
            CLVF_B.y6 = sin(CLVF_B.theta_n);
            CLVF_B.vc[0] = 0.0;
            CLVF_B.vc[3] = -CLVF_B.rtb_TmpSignalConversionAtSFun_j;
            CLVF_B.vc[6] = CLVF_B.TmpSignalConversionAtSFun_n[1];
            CLVF_B.vc[1] = CLVF_B.rtb_TmpSignalConversionAtSFun_j;
            CLVF_B.vc[4] = 0.0;
            ...
            if (CLVF_B.theta_n <= CLVF_P.theta_d) {
              // 'LVF:40' theta_N = (theta/theta_d)*pi/2;
              CLVF_B.vc_dot = CLVF_B.theta_n / CLVF_P.theta_d *
            ...
            CLVF_B.vc_m = -CLVF_B.v_rel * CLVF_B.dgdr;
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 9; CLVF_B.uElOffset1
                 ++) {
              CLVF_B.b_I_f[CLVF_B.uElOffset1] = 0;
            }

            for (CLVF_B.yElIdx = 0; CLVF_B.yElIdx < 3; CLVF_B.yElIdx++) {
              CLVF_B.b_I_f[CLVF_B.yElIdx + 3 * CLVF_B.yElIdx] = 1;
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 9; CLVF_B.uElOffset1
              ...
              CLVF_B.b_I[CLVF_B.uElOffset1] = (static_cast<real_T>
                (CLVF_B.b_I_f[CLVF_B.uElOffset1]) - CLVF_B.y[CLVF_B.uElOffset1])
                / CLVF_B.RED_Tz_Shoulder;
            }
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 9; CLVF_B.uElOffset1
                 ++) {
              CLVF_B.c_I_g[CLVF_B.uElOffset1] = 0;
            }
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 9; CLVF_B.uElOffset1
                 ++) {
              CLVF_B.d_I_g[CLVF_B.uElOffset1] = 0;
            }
            ...
            CLVF_B.rtb_TmpSignalConversionAtSFun_l =
              ...
              CLVF_B.rtb_TmpSignalConversionAtSFun_j * CLVF_B.e_hat[2];
            CLVF_B.vc[0] = 0.0;
            ...
            CLVF_B.vc_dot = -CLVF_B.g_dot * CLVF_B.dgdr *
              CLVF_B.rtb_TmpSignalConversionAtSFun_l + CLVF_B.vc_dot *
              CLVF_B.theta_dot;
            ...
            CLVF_B.dgdr = CLVF_B.g_dot * CLVF_B.g *
              CLVF_B.rtb_TmpSignalConversionAtSFun_l + CLVF_B.dgdr *
              CLVF_B.theta_dot;
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3; CLVF_B.uElOffset1
              ...
              CLVF_B.hC_T[CLVF_B.uElOffset1] = (((CLVF_B.vc[CLVF_B.uElOffset1 +
                ...
                + ((CLVF_B.vc_m *
                   ...
                   CLVF_B.C_IB_b[CLVF_B.uElOffset1]);
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 9; CLVF_B.uElOffset1
                 ++) {
              CLVF_B.b_I[CLVF_B.uElOffset1] = (static_cast<real_T>
                (CLVF_B.b_I_f[CLVF_B.uElOffset1]) -
              ...
              CLVF_B.vc[CLVF_B.uElOffset1] = (CLVF_B.C_IB_c[CLVF_B.uElOffset1] -
                ...
                CLVF_B.rtb_TmpSignalConversionAtSFu_pp * static_cast<real_T>
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 9; CLVF_B.uElOffset1
                 ++) {
              CLVF_B.b_I[CLVF_B.uElOffset1] = static_cast<real_T>
                (CLVF_B.c_I_g[CLVF_B.uElOffset1]) - CLVF_B.y[CLVF_B.uElOffset1];
              CLVF_B.d_I[CLVF_B.uElOffset1] = static_cast<real_T>
                (CLVF_B.d_I_g[CLVF_B.uElOffset1]) -
            ...
            CLVF_B.rC_D_tmp[2] = CLVF_B.y7 *
              CLVF_B.rtb_TmpSignalConversionAtSFun_l;
            CLVF_B.C_IB_b[0] = (CLVF_B.w_dot_I[1] *
                                CLVF_B.rtb_TmpSignalConversionAtSFun_j -
                                CLVF_B.w_dot_I[2] *
                                CLVF_B.TmpSignalConversionAtSFun_n[1]) *
              CLVF_B.RED_Tz_Shoulder;
            CLVF_B.C_IB_b[1] = (CLVF_B.w_dot_I[2] *
                                CLVF_B.TmpSignalConversionAtSFun_n[0] -
                                CLVF_B.w_dot_I[0] *
                                CLVF_B.rtb_TmpSignalConversionAtSFun_j) *
              CLVF_B.RED_Tz_Shoulder;
            CLVF_B.C_IB_b[2] = (CLVF_B.w_dot_I[0] *
                                CLVF_B.TmpSignalConversionAtSFun_n[1] -
                                CLVF_B.w_dot_I[1] *
                                CLVF_B.TmpSignalConversionAtSFun_n[0]) *
              CLVF_B.RED_Tz_Shoulder;
            ...
            for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3; CLVF_B.uElOffset1
              ...
              CLVF_B.rtb_TmpSignalConversionAtSFu_pb[CLVF_B.uElOffset1] = 0.0;
          ...
          CLVF_B.vc_m = cos(CLVF_DW.RED_Rz);
          CLVF_B.C_IB[0] = CLVF_B.vc_m;
          CLVF_B.C_IB[3] = CLVF_B.RED_Tz_Wrist;
          CLVF_B.C_IB[6] = 0.0;
          CLVF_B.C_IB[1] = -CLVF_B.RED_Tz_Wrist;
          CLVF_B.C_IB[4] = CLVF_B.vc_m;
          CLVF_B.C_IB[7] = 0.0;
          CLVF_B.C_IB[2] = 0.0;
          CLVF_B.C_IB[5] = 0.0;
          CLVF_B.C_IB[8] = 1.0;
      ...
      if ((CLVF_P.WhoAmI == 1.0) || (CLVF_P.simMode == 1.0)) {
        ...
        if (CLVF_DW.Univ_Time < CLVF_P.Phase3_SubPhase1_End) {
          ...
          // Sum: '<S413>/Subtract2'
          CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_ma.Ox[0] -
            CLVF_B.sf_MATLABFunction3_ca.Ox[0];
          CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_ma.Ox[1] -
          ...
          if (CLVF_DW.Univ_Time < CLVF_P.Phase3_SubPhase4_End) {
            ...
            // Sum: '<S426>/Subtract2'
            CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_e.Ox[0] -
              CLVF_B.sf_MATLABFunction3_k5.Ox[0];
            CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_e.Ox[1] -
     ...
     case 4:
      ...
      if ((CLVF_P.WhoAmI == 2.0) || (CLVF_P.simMode == 1.0)) {
        ...
        // Sum: '<S444>/Subtract2'
        CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_p.Ox[0] -
          CLVF_B.sf_MATLABFunction3_b.Ox[0];
        CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_p.Ox[1] -
      ...
      if ((CLVF_P.WhoAmI == 1.0) || (CLVF_P.simMode == 1.0)) {
        ...
        // Sum: '<S470>/Subtract2'
        CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_i.Ox[0] -
          CLVF_B.sf_MATLABFunction3_c1.Ox[0];
        CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_i.Ox[1] -
     ...
     case 5:
      ...
      if ((CLVF_P.WhoAmI == 2.0) || (CLVF_P.simMode == 1.0)) {
        ...
        // Sum: '<S487>/Subtract2'
        CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_g.Ox[0] -
          CLVF_B.sf_MATLABFunction3_o.Ox[0];
        CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_g.Ox[1] -
      ...
      if ((CLVF_P.WhoAmI == 1.0) || (CLVF_P.simMode == 1.0)) {
        ...
        // Sum: '<S513>/Subtract2'
        CLVF_B.rtb_Subtract2_l_c[0] = CLVF_B.sf_MATLABFunction2_mx.Ox[0] -
          CLVF_B.sf_MATLABFunction3_bc.Ox[0];
        CLVF_B.rtb_Subtract2_l_c[1] = CLVF_B.sf_MATLABFunction2_mx.Ox[1] -
    ...
    if (CLVF_P.simMode == 1.0) {
      ...
      CLVF_B.rtb_Compare_l = (CLVF_DW.BLUE_Rz == CLVF_P.Constant_Value_h);
      ...
      if ((CLVF_B.rtb_Compare_l && (CLVF_DW.DiscreteTimeIntegrator_PrevRese <= 0))
          || ((!CLVF_B.rtb_Compare_l) &&
      ...
      CLVF_B.rtb_Compare_n_g = (CLVF_DW.BLACK_Rz == CLVF_P.Constant_Value_j);
      ...
      if ((CLVF_B.rtb_Compare_n_g && (CLVF_DW.DiscreteTimeIntegrator1_PrevRes <=
            0)) || ((!CLVF_B.rtb_Compare_n_g) &&
      ...
      CLVF_B.rtb_Compare_nd_d = (CLVF_DW.RED_Rz == CLVF_P.Constant_Value_c);
      ...
      if ((CLVF_B.rtb_Compare_nd_d && (CLVF_DW.DiscreteTimeIntegrator2_PrevRes <=
            0)) || ((!CLVF_B.rtb_Compare_nd_d) &&
      ...
      CLVF_B.vc_m = CLVF_DW.RED_Fx_Sat / CLVF_P.model_param[0] *
      ...
      CLVF_B.d_T[0] = CLVF_P.VelocitytoPosition_gainval_ad * CLVF_B.vc_m +
        CLVF_DW.VelocitytoPosition_DSTATE_f[0];
      CLVF_B.x_ddot[0] = CLVF_B.vc_m;
      ...
      CLVF_B.vc_m = CLVF_DW.RED_Fy_Sat / CLVF_P.model_param[0] *
        CLVF_P.AccelerationtoVelocity_gainva_i +
        CLVF_DW.AccelerationtoVelocity_DSTATE_h[1];

      // DiscreteIntegrator: '<S532>/Velocity to Position'
      CLVF_B.d_T[1] = CLVF_P.VelocitytoPosition_gainval_ad * CLVF_B.vc_m +
        CLVF_DW.VelocitytoPosition_DSTATE_f[1];
      CLVF_B.x_ddot[1] = CLVF_B.vc_m;
      ...
      CLVF_B.vc_m = (CLVF_DW.RED_Tz_Sat + CLVF_DW.RED_Tz_RW_Sat) /
        CLVF_P.model_param[1] * CLVF_P.AccelerationtoVelocity_gainva_i +
        CLVF_DW.AccelerationtoVelocity_DSTATE_h[2];

      // DiscreteIntegrator: '<S532>/Velocity to Position'
      CLVF_B.d_T[2] = CLVF_P.VelocitytoPosition_gainval_ad * CLVF_B.vc_m +
      ...
      // Update for DiscreteIntegrator: '<S532>/Acceleration  to Velocity'
      CLVF_DW.AccelerationtoVelocity_DSTATE_h[2] = CLVF_B.vc_m;
    ...
    if ((CLVF_P.WhoAmI == 2.0) || (CLVF_P.simMode == 1.0)) {
      ...
      for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 8; CLVF_B.uElOffset1++) {
        ...
        CLVF_B.rtb_RemoveNegatives_i_c[CLVF_B.uElOffset1] =
      ...
      CLVF_MATLABFunction2(CLVF_B.rtb_RemoveNegatives_i_c,
     ...
     case 0:
      ...
      switch (CLVF_B.rtAction) {
       case 0:
        ...
        CLVF_B.rtb_Compare_l = (CLVF_B.Compare_e[0] || CLVF_B.Compare_e[1] ||
        ...
        if (CLVF_B.rtb_Compare_l || CLVF_B.Compare_e[12]) {
       ...
       case 1:
        ...
        if (CLVF_B.rtAction == 0) {
          ...
          stream_phasespace(&CLVF_B.RED_Tz_Elbow, &CLVF_B.RED_Tz_Shoulder,
                            &CLVF_B.StreamPhaseSpacetoPlatform[3], &CLVF_B.vc_m,
                            &CLVF_B.RED_Tz_Wrist,
                            &CLVF_B.StreamPhaseSpacetoPlatform[6], &CLVF_B.y7,
                            &CLVF_B.vc_dot, &CLVF_B.g, &CLVF_B.theta_dot,
                            &CLVF_B.theta_n, &CLVF_B.v_rel, &CLVF_B.dgdr,
          ...
          CLVF_B.StreamPhaseSpacetoPlatform[4] = CLVF_B.vc_m / 1000.0;
          ...
          CLVF_B.StreamPhaseSpacetoPlatform[10] = CLVF_B.theta_n / 1000.0;
    ...
    for (CLVF_B.uElOffset1 = 0; CLVF_B.uElOffset1 < 3; CLVF_B.uElOffset1++) {
      CLVF_B.vc_m = ((CLVF_B.C_IB[3 * CLVF_B.uElOffset1 + 1] *
      ...
      CLVF_B.LSM9DS1IMUSensor_o3[CLVF_B.uElOffset1] = CLVF_B.vc_m * 4.0 /
        32768.0;
    ...
    if ((CLVF_P.WhoAmI == 2.0) && (CLVF_P.simMode == 0.0)) {
      ...
      CLVF_B.rtb_Compare_l = (CLVF_B.In1_ln == CLVF_P.Constant_Value_i);
      ...
      if ((CLVF_B.rtb_Compare_l && (CLVF_DW.DiscreteTimeIntegrator1_PrevR_d <= 0))
          || ((!CLVF_B.rtb_Compare_l) &&
    ...
    if ((CLVF_P.WhoAmI == 3.0) && (CLVF_P.simMode == 0.0)) {
      ...
      CLVF_B.rtb_Compare_l = (CLVF_B.In1_df == CLVF_P.Constant_Value_m);
      ...
      if ((CLVF_B.rtb_Compare_l && (CLVF_DW.DiscreteTimeIntegrator1_PrevR_h <= 0))
          || ((!CLVF_B.rtb_Compare_l) &&
    ...
    if ((CLVF_P.WhoAmI == 1.0) && (CLVF_P.simMode == 0.0)) {
      ...
      CLVF_B.rtb_Compare_l = (CLVF_B.In1_eu == CLVF_P.Constant_Value_fd);
      ...
      if ((CLVF_B.rtb_Compare_l && (CLVF_DW.DiscreteTimeIntegrator1_PrevR_m <= 0))
          || ((!CLVF_B.rtb_Compare_l) &&
